  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="secondaryGray" size="sm" className="h-8 border-dashed">
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        isSelected ? 'bg-brand-500 text-white' : 'opacity-50 [&_svg]:invisible'
                      )}
                    >
                      <CheckIcon className={cn('h-4 w-4')} />
                    </div>
                    {option.icon && <option.icon className="mr-2 size-4 text-text-tertiary" />}
